      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="https://app-airbox.netlify.app/sign-in" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-gray-700 hover:text-black">Login &gt;</a>
            <a href="https://app-airbox.netlify.app/sign-up" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
              Sign up
            </a>
          </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-4">
              ...
              <div className="border-t border-gray-100 pt-4 flex flex-col gap-3">
                <a href="https://app-airbox.netlify.app/sign-in" target="_blank" rel="noopener noreferrer" className="block text-center text-base font-medium text-gray-900 py-2" onClick={() => setIsMobileMenuOpen(false)}>Login</a>
                <a href="https://app-airbox.netlify.app/sign-up" target="_blank" rel="noopener noreferrer" className="block text-center px-4 py-3 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-black hover:bg-gray-800" onClick={() => setIsMobileMenuOpen(false)}>
                  Sign up
                </a>
              </div>
            </div>
